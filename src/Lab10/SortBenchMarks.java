...
public class SortBenchMarks
{
    public SortBenchMarks()
    {
		...
		System.out.println("Number of swaps made with selection sort: " +
		                   ssort.getNumSwaps() +
                           " /// Number of comparisons made with selection sort: " +
                           ssort.getNumComparisons() +
                           " /// Number of assignments made with selection sort: " +
                           ssort.getNumAssignments());

		System.out.println("Number of swaps made with insertion sort: " +
		                   isort.getNumSwaps() +
                           " /// Number of comparisons made with insertion sort: " +
                           isort.getNumComparisons()+
                           " /// Number of assignments made with insertion sort: " +
                           isort.getNumAssignments());

		System.out.println("Number of swaps made with Quicksort: " +
		                   qsort.getNumSwaps() +
                           " /// Number of comparisons made with Quicksort: " +
                           qsort.getNumComparisons()+
                           " /// Number of assignments made with Quicksort: " +
